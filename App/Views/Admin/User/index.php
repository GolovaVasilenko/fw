<div class="button-wrapp">
    <a class="btn btn-primary btn-sm" href="/control-panel/user/add">Add new user</a>
</div>
<div class="row">
    <div class="col-sm-12">
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            ...
            <tr role="row">
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">User login</th>
            ...
            <tr role="row" class="odd">
                ...
                <td>
                    <a href="/control-panel/user/edit">
                        <i class="fa fa-edit"></i>
                    </a>&nbsp;
                    <a href="/control-panel/user/delete" class="remove-iteme">
