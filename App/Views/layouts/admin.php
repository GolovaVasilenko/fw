    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="<?=ADMIN;?>page">
                        <i class="fa fa-sticky-note"></i> <span>Страницы</span>
                    </a>
                </li>
                <li>
                    <a href="<?=ADMIN;?>order">
                        <i class="fa fa-cart-plus"></i> <span>Заказы</span>
                    </a>
                </li>
                <li>
                    <a href="<?=ADMIN;?>brand">
                        <i class="fa fa-star"></i> <span>Брэнды</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="<?=ADMIN;?>">
                        <i class="fa fa-bars"></i> <span>Категории</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?=ADMIN;?>category/"><i class="fa fa-circle-o"></i> Список категорий</a></li>
                        <li><a href="<?=ADMIN;?>category/add"><i class="fa fa-circle-o"></i> Добавить категорию</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="<?=ADMIN;?>product">
                        <i class="fa fa-cubes"></i> <span>Товары</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?=ADMIN;?>product/"><i class="fa fa-circle-o"></i> Список товаров</a></li>
                        <li><a href="<?=ADMIN;?>product/add"><i class="fa fa-circle-o"></i> Добавить товар</a></li>
                        <li><a href="<?=ADMIN;?>attribute/"><i class="fa fa-circle-o"></i> Свойства товара</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="<?=ADMIN;?>user">
                        <i class="fa fa-user"></i> <span>Покупатели</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?=ADMIN;?>user/"><i class="fa fa-circle-o"></i> Список пользователей</a></li>
                        <li><a href="<?=ADMIN;?>user/add"><i class="fa fa-circle-o"></i> Добавить пользователя</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?=ADMIN;?>settings"><i class="fa fa-circle-o"></i> Основные настройки</a></li>
                        <li><a href="<?=ADMIN;?>cache"><i class="fa fa-circle-o"></i> Управление кешем</a></li>
                    </ul>
                </li>
            </ul>
        </section>
